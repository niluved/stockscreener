...
def main():
    ...
    print(f'${df_info['Ticker'].nunique()} ticker scaricati / {len(tl.tickers)} ticker iniziali')
    ...
    # stampa il numero di valori unici nella colonna Ticker rispetto al numero totale di ticker iniziali
    print(f'${df_income_trim['Ticker'].nunique()} ticker scaricati / {len(tl.tickers)} ticker iniziali')
